...
For the IAM role + external-id setup, see [docs/byo-cloud-setup.md](docs/byo-cloud-setup.md). For the full architecture, see [docs/architecture.md](docs/architecture.md). For the manifest schema, see [docs/exam-schema.md](docs/exam-schema.md). To add your own exam, see [docs/authoring-an-exam.md](docs/authoring-an-exam.md).
